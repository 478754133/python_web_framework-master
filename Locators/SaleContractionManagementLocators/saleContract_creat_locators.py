...
class SaleContractCreatLocators:
    ...
    #业务类型->一般国内贸易
    businesstypelist_loc = (By.CSS_SELECTOR, "body > div.el-select-dropdown.el-popper.popperClass > div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul >li")
    ...
    #币种->人民币
    currencylist_loc = (By.CSS_SELECTOR, "body > div:nth-child(8) > div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul > li")
    ...
    #我方合同编号
    contractnumberother_loc = (By.XPATH, "//div/div/div[21]/div/div/div[1]/input")
    ...
    # //div[6]/div[1]/div[1]/ul/li
    # constracttypelist_loc = (By.XPATH, "//div[6]/div[1]/div[1]/ul/li")
    ...
    #标准类型->非标准合同
    standardtypelist_loc = (By.XPATH, "//div[13]/div[1]/div[1]/ul/li")
    ...
    #客户信息
    customer_loc = (By.XPATH, "(//input[@type='text'])[26]")
    # 客户信息->客户列表
    customerlist_loc = (By.XPATH, "//div[14]/div[1]/div[1]/ul/li")
