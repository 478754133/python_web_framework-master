...
class PurchaseContractCreatLocators:
    '''------组件类按钮提示框-------'''
    #审批通过
    ...
    #业务类型->一般国内贸易
    businesstypelist_loc = (By.CSS_SELECTOR, "div[x-placement='bottom-start']  div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul li")

    #订单类型:下拉
    ordertype_loc = (By.CSS_SELECTOR, ".el-col:nth-child(5) .el-input:nth-child(1) .el-select__caret")
    #订单类型->产品销售
    ordertypelist_loc = (By.CSS_SELECTOR, "body > div:nth-child(7) > div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul > li")

    #币种:下拉
    currency_loc = (By.CSS_SELECTOR, "input[placeholder='请选择币种']")
    #币种->人民币
    currencylist_loc = (By.CSS_SELECTOR, "div[x-placement='bottom-start']  div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul li")

    #合同有效期:start:开始日期  ebody > div.el-select-dropdown.el-popper.popperClass > div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul >lind:结束日期
    ...
    #收款条件->货到后付款
    # collectiontermslist_loc = (By.XPATH, "//i[contains(.,'货到后付款')]")
    collectiontermslist_loc = (By.CSS_SELECTOR, "div[x-placement='bottom-start']  div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul li i")
    #收款条件说明
    ...
    #收款方式->电汇
    paymentmethodlist_loc = (By.CSS_SELECTOR, "div[x-placement='bottom-start']  div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul li")
    paymentmethod_1_loc = (By.XPATH, "//span[contains(.,'电汇')]")

    #我方合同编号
    contractnumberother_loc = (By.XPATH, "//div/div/div[20]/div/div/div[1]/input")
    ...
    productiontypelist_loc= (By.CSS_SELECTOR, "div[x-placement='bottom-start']  div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul li")

    #收单地点
    receivinglocation_loc = (By.XPATH,"//*[@id='hcBox']/div/div[2]/div/div/form/div[1]/div[2]/div/div/div[15]/div/div/span/div/div/input")
    receivinglocationlist_loc = (By.CSS_SELECTOR,"div[x-placement='bottom-start']  div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul li")

    #合同类型
    constracttype_loc = (By.CSS_SELECTOR, ".el-col:nth-child(16) .el-select__caret")
    #合同类型->零单合同
    constracttype_1_loc = (By.XPATH, "//li/span[text()='零单合同']")

    constracttypelist_loc = (By.CSS_SELECTOR, "div[x-placement='bottom-start']  div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul li")
    ...
    #标准类型->非标准合同
    standardtypelist_loc = (By.CSS_SELECTOR, "div[x-placement='bottom-start']  div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul li")
    ...
    #客户信息
    supply_loc = (By.XPATH, "//*[@id='hcBox']/div/div[2]/div/div/form/div[2]/div[2]/div/div/div[3]/table/tbody/tr/td[1]/div/div/div/span/div/div[1]/span")
    # 客户信息->客户列表
    supplylist_loc = (By.CSS_SELECTOR, "div[x-placement='top-start']  div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul li span")
